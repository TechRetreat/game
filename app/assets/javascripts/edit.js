...
$('#set-theme').click(function(){
    ...
    $("#set-theme").toggleClass('white-icon');
    $("#set-theme").toggleClass('fa-sun-o');
    $('#set-theme').toggleClass('fa-moon-o');
    $('#publish').toggleClass('white-icon');
    $('#save').toggleClass('white-icon');
});
